...
/*
 * Checkout action save order and send email to customer
 */
                ...
                newOrders.save(function(err,orderdata){
                    if (err){
                        ...
                        for(var i = 0; i < req.session.productids.length; i++){
                           ...
                           html += '<table style="padding-top:10px; padding-bottom:25px; border-top: 1px solid #ddd;" width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding-right:10px; width:50%; vertical-align: top;"><h4 style="padding:10px; background-color: #f5f5f5;">Billing Address:</h4><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding:5px 0;vertical-align: top;width:65px;"><b>Name :</b></td><td style="padding:5px 0;vertical-align: top;">'+req.user.local.firstName+' '+req.user.local.lastName+'</td></tr><tr><td style="padding:5px 0;vertical-align: top;width:65px;"><b>Email :</b></td><td style="padding:5px 0;vertical-align: top;"><a href="" target="_blank">'+req.user.local.email+'</a></td></tr><tr><td style="padding:5px 0;vertical-align: top;width:65px;"><b>Address :</b></td><td style="padding:5px 0;vertical-align: top;">'+req.user.local.locationCity+' '+req.user.local.locationState+' '+req.user.local.locationCountry+' '+req.user.local.locationZipcode+'</td></tr></tbody></table></td>';
                    ...
                    if(req.body.ship_email!=""){
                       ...
                       html += '<td style="padding-left:10px; width:50%; vertical-align: top;"><h4 style="padding:10px; background-color: #f5f5f5;">Shipping Address:</h4><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding:5px 0;vertical-align: top;width:65px;"><b>Name :</b></td><td style="padding:5px 0;vertical-align: top;">'+req.body.ship_firstname+' '+req.body.ship_lastname+'</td></tr><tr><td style="padding:5px 0;vertical-align: top;width:65px;"><b>Email :</b></td><td style="padding:5px 0;vertical-align: top;"><a href="" target="_blank">'+req.body.ship_email+'</a></td></tr><tr><td style="padding:5px 0;vertical-align: top;width:65px;"><b>Address :</b></td><td style="padding:5px 0;vertical-align: top;">'+req.body.ship_addr1+' '+req.body.ship_city+' '+req.body.ship_state+' '+req.body.ship_country+','+req.body.ship_postcode+'</td></tr></tbody></table></td></tr></tbody></table>';
...
/*
* Route to delete previous events
*/
...
/*
* Route for removing notification from notifications box
*/
...
/*
* Route for submit product rating
*/
